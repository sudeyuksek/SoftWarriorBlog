namespace Blog.WebUI.Management.Rules
{
    ...
    public class RedirectToHttpsWwwNonWwwRule : IRule
    {
        ...
        public virtual void ApplyRule(RewriteContext context)
        {
            ...
            if (redirect_to_https == true && req.IsHttps == false)
            {
                ...
                if (redirect_to_www == true && redirect_to_non_www == false && host.StartsWith("www") == false)
                {
                    uriBuilder.Host = "www." + uriBuilder.Host;
                }
                else if (redirect_to_non_www == true && redirect_to_www == false && host.StartsWith("www") == true)
                {
                    uriBuilder.Host = uriBuilder.Host.Replace("www.", "");
                }

                if (append_slash == true && req.Path.HasValue && !req.Path.Value.EndsWith('/'))
            ...
            else if (redirect_to_www == true && redirect_to_non_www == false && host.StartsWith("www.") == false)
            {
                // Modify the host
                uriBuilder.Host = "www." + uriBuilder.Host;
